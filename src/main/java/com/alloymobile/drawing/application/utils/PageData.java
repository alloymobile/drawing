package com.alloymobile.drawing.application.utils;
...
public class PageData {
    ...
    public PageData(Environment environment) {
        this.pageNumber = Integer.parseInt(Objects.requireNonNull(environment.getProperty("drawing.page-number")));
        this.pageSize = Integer.parseInt(Objects.requireNonNull(environment.getProperty("drawing.page-size")));
    }
